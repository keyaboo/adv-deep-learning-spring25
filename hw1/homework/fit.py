    ...
    for epoch in range(steps):
        ...
        with torch.no_grad():
            ...
            if accuracy > best_accuracy:
                ...
                # Define the path based on model name
...
if __name__ == "__main__":
    ...
    Fire({"load_model_and_fit_binary_classifier": load_model_and_fit_binary_classifier})
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train a binary classifier using a given model.")
    ...
    load_model_and_fit_binary_classifier(args.model_name, args.steps)
